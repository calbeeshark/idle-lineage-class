    const MOB_DROPS = {
        ...
        '黑暗妖精將軍': [['scroll_acc',0.001],['scroll_armor', 0.5], ['scroll_weapon', 0.5], ['bk_reduction_armor', 0.05], ['bk_meteor', 0.001], ['bk_dark_poison', 1], ['bk_dark_burn', 1], ['bk_dark_poisonres', 1], ['bk_dark_dex', 0.6], ['bk_dark_double', 0.1], ['bk_dark_fang', 0.5], ['mat_black_blood', 1], ['mat_steel_chunk',10], ['relic_general_swordguard',80]],
        // ===== 魔獸訓練場 =====
        ...
        '夢幻之島地精靈王': [['arm_69', 1], ['arm_63',5], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_revive',1], ['panacea_con',1], ['mat_earth_breath',1], ['relic_earthking_resist',80]],
        ...
        '巴土瑟': [['item_olin_diary',1],['arm_87',5], ['arm_90',10], ['arm_54',1], ['acc_117',0.01], ['amu_int',0.1], ['scroll_weapon',10], ['scroll_armor',20], ['scroll_acc',1], ['new_item_150',1], ['new_item_154',5], ['new_item_155',0.5], ['new_item_156',0.1], ['bk_cancel',0.1], ['bk_quake',0.1], ['bk_elf_groundtrap',5], ['bk_elf_earthbless',1], ['acc_119',0.1], ['acc_125',0.1], ['relic_rockmage_secret',80]],
        ...
        '夢幻之島水精靈王': [['arm_69', 1], ['arm_63',5], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_revive',1], ['panacea_int',1], ['mat_water_breath',1], ['relic_waterking_caress',80]],
        ...
        '夢幻之島火精靈王': [['arm_69', 1], ['arm_63',5], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_revive',1], ['panacea_str',1], ['mat_fire_breath',1], ['relic_fireking_blast',80]],
        ...
        '獨角獸': [['wpn_18',3], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_poly',1], ['panacea_cha',1], ['mat_unicorn_horn',0.1], ['relic_pure_maiden_love',80]],
        ...
        '紅鬼魂': [['item_lost_soul',1],['amr_robe',3], ['glv_crystal',0.01], ['bk_elf_seal',0.05], ['bk_dark_shadow',0.1], ['item_soul_orb',0.01], ['mat_moonlight_breath', 0.01], ['relic_magic_resist_shirt',80]],
        ...
        '夢幻之島風精靈王': [['arm_69', 1], ['arm_63',5], ['scroll_weapon',5], ['scroll_armor',10], ['scroll_revive',1], ['panacea_dex',1], ['mat_wind_breath',1], ['relic_windking_roar',80]],
    ...
    [
        ['妖魔', 'relic_orc_lid', 80],
        ['哥布林', 'relic_goblin_blade', 80],
        ['妖魔弓箭手', 'relic_orcarcher_bow', 80],
        ['地靈', 'relic_gremlin_club', 80],
        ['蘑菇', 'relic_mushroom_cap', 80],
        ['污染的地精靈', 'relic_gnomeearth_tshirt', 80],
        ['狼', 'relic_wolf_shawl', 80],
        ['哈士奇', 'relic_husky_bone', 80],
        ['侏儒', 'relic_dwarf_sheet', 80],
        ['熊', 'relic_bear_fishbone', 80],
        ['牧羊犬', 'relic_shepherd_boots', 80],
        ['人形殭屍', 'relic_zombie_shin', 80],
        ['杜賓狗', 'relic_doberman_fang', 80],
        ['安普長老', 'relic_amp_staff', 80],
        ['污染的安特', 'relic_ent_bark', 80],
        ['漂浮之眼', 'relic_eye_crystal', 80],
        ['妖魔鬥士', 'relic_gladiator_scimitar', 80],
        ['冰原狼人', 'relic_icefield_pick', 80],
        ['怪手', 'relic_monsterhand_skin', 80],
        ['狼人', 'relic_werewolf_mace', 80],
        ['侏儒戰士', 'relic_dwarf_chainmail', 80],
        ['骷髏', 'relic_weathered_skull', 80],
        ['妖魔殭屍', 'relic_orc_nail', 80],
        ['甘地妖魔', 'relic_orc_gloves', 80],
        ['污染的潘', 'relic_pan_staff', 80],
        ['鱷魚', 'relic_croc_tshirt', 80],
        ['冰之女王侍女', 'relic_maid_gift', 80],
        ['巨蟻', 'relic_giantant_antenna', 80],
        ['妖魔法師', 'relic_orcmage_cloth', 80],
        ['骷髏弓箭手', 'relic_elastic_rib', 80],
        ['蟑螂人', 'relic_roach_shell', 80],
        ['石頭高崙', 'relic_golem_fist', 80],
        ['羅孚妖魔', 'relic_orc_cleaver', 80],
        ['骷髏斧手', 'relic_strong_femur', 80],
        ['骷髏斧手', 'relic_forgotten_spear', 80],
        ['夏洛伯', 'relic_spider_claw', 80],
        ['妖魔巡守', 'relic_scout_scope', 80],
        ['哈柏哥布林', 'relic_hobgoblin_grinder', 80],
        ['阿吐巴妖魔', 'relic_orc_butcher', 80],
        ['都達瑪拉妖魔', 'relic_orc_pole', 80],
        ['歐熊', 'relic_bear_fur', 80],
        ['蜥蜴人', 'relic_lizard_shield', 80],
        ['穴居人', 'relic_caveman_webbing', 80],
        ['史巴托', 'relic_sparta_grudge', 80],
        ['食屍鬼', 'relic_ghoul_bracelet', 80],
        ['鯊魚', 'relic_shark_teeth', 80],
        ['黑騎士', 'relic_guard_towershield', 80],
        // 🏺 遺物 第二批（v3.1.1·29 件）
        ['黑騎士搜索隊', 'relic_guard_spear', 80],
        ['人魚', 'relic_mermaid_tear', 80],
        ['那魯加妖魔', 'relic_orc_loincloth', 80],
        ['萊肯', 'relic_crescent_earring', 80],
        ['楊果里恩', 'relic_ungoliant_plate', 80],
        ['蟹人', 'relic_crab_claw', 80],
        ['狂野之毒', 'relic_wild_mane_coat', 80],
        ['狂野毒牙', 'relic_venom_fang', 80],
        ['歐姆', 'relic_ohm_shackle', 80],
        ['巨大兵蟻', 'relic_soldierant_carapace', 80],
        ['鼠人', 'relic_ratman_skewer', 80],
        ['海星', 'relic_starfish_arm', 80],
        ['遺忘之島鱷魚', 'relic_croc_soul', 80],
        ['遺忘之島蜥蜴人', 'relic_lizard_scale', 80],
        ['狂暴蜥蜴人', 'relic_veteran_lizard_gauntlet', 80],
        ['狂野之魔', 'relic_black_gale', 80],
        ['長老', 'relic_elder_thunder', 80],
        ['卡司特', 'relic_green_imp_nail', 80],
        ['狂暴的歐姆', 'relic_ohm_hidepants', 80],
        ['食人妖精', 'relic_ogre_mawashi', 80],
        ['蛇女', 'relic_lamia_tailscale', 80],
        ['魔蝙蝠', 'relic_bat_wing', 80],
        ['底比斯 曼陀羅草(白)', 'relic_mandra_spirit', 80],
        ['歐姆裝甲兵', 'relic_ohm_heavyarmor', 80],
        ['地獄犬', 'relic_cerberus_wand', 80],
        ['希爾黛斯', 'relic_watersprite_string', 80],
        ['龍龜', 'relic_dragonturtle_shell', 80],
        ['藍尾蜥蜴', 'relic_bluetail_tail', 80],
        ['重裝蜥蜴人', 'relic_lizardman_cleaver', 80],
        // 🏺 遺物 第三批（v3.1.2·19 件）
        ['狂暴的歐姆裝甲兵', 'relic_ohm_maul', 80],
        ['闇之精靈', 'relic_darkspirit_shroud', 80],
        ['犰狳', 'relic_armadillo_helm', 80],
        ['白螞蟻群', 'relic_whiteant_shell', 80],
        ['高等蜥蜴人', 'relic_high_lizard_armguard', 80],
        ['奇異鸚鵡', 'relic_parrot_beak', 80],
        ['海賊骷髏', 'relic_pirate_scimitar', 80],
        ['毒蠍', 'relic_scorpion_sting', 80],
        ['哈維', 'relic_harvey_claw', 80],
        ['底比斯 曼陀羅草', 'relic_death_leaf', 80],
        ['黑暗妖精魔法學徒', 'relic_apprentice_wand', 80],
        ['魔熊', 'relic_bear_vitality', 80],
        ['歐姆民兵', 'relic_militia_armor', 80],
        ['骷髏神射手', 'relic_sharpshooter_bow', 80],
        ['骷髏警衛', 'relic_guard_pike', 80],
        ['黑暗精靈', 'relic_whirlwind_xbow', 80],
        ['黑暗妖精殘兵(弓)', 'relic_darkremnant_boots', 80],
        ['歐吉', 'relic_ogi_greataxe', 80],
        ['多羅', 'relic_doro_vitality', 80],
        // 🏺 遺物 第四批（v3.1.4）
        ['伊萊克頓', 'relic_deepfish_skin', 80],
        ['強盜', 'relic_bandit_token', 80],
        ['雪人', 'relic_yeti_fist', 80],
        ['雪人', 'arm_yeti_gloves', 0.01],   // 一般防具 雪人手套（非遺物·0.01%）
        ['紙人', 'relic_paper_cloak', 80],
        ['黑暗妖精盜賊', 'relic_darkthief_claw', 80],
        ['闇精靈王', 'relic_darkelf_chainsword', 80],
        ['海賊骷髏士兵', 'relic_seawater_shirt', 80],
        ['骷髏鬥士', 'relic_fighter_axe', 80],
        ['奎斯坦修', 'relic_hermitcrab_shell', 80],
        ['爆彈花', 'relic_bombflower_core', 80],
        ['底比斯 聖甲蟲', 'relic_scarab_shin', 80],
        ['黑暗妖精殘兵(劍)', 'relic_darkelf_grindblade', 80],
        ['黑暗妖精殘兵(十字弓)', 'relic_darkelf_shootglove', 80],
        ['巨人', 'relic_giant_clubfrag', 80],
        ['食人妖精王', 'relic_ogreking_collar', 80],
        ['莫妮亞', 'relic_monia_sandals', 80],
        ['艾爾摩士兵', 'relic_wornout_underwear', 80],
        ['夢幻之島蘑菇', 'relic_dream_mushroom_soul', 80],
        // 🏺 遺物 第六批（v3.1.13·11 件）
        ['夢幻之島鬼火', 'relic_wisp_remnant', 80],
        ['冰人', 'relic_frostdeath_breath', 80],
        ['黑暗妖精殘兵(法師)', 'relic_remnant_barrier', 80],
        ['喚獸師', 'relic_summoner_whip', 80],
        ['金屬蜈蚣', 'relic_metalshell_shin', 80],
        ['格利芬', 'relic_griffin_claw', 80],
        ['艾爾摩法師', 'relic_wither_amulet', 80],
        ['密密', 'relic_stalker_chest', 80],
        ['強化巨蟻', 'relic_giantant_eye', 80],
        ['巨大鱷魚', 'relic_croc_fang', 80],
        ['冰石高崙', 'relic_icestone_maul', 80],
        ['底比斯 聖甲蟲(藍)', 'relic_scarab_nest', 80],   // 🏺 v3.1.16：聖甲蟲的孵育巢（aggroHide 迴避仇恨盾）
        // 🏺 遺物 第七批（v3.1.18·17 件）
        ['黑法師', 'relic_blackmage_pants', 80],
        ['變種蛇女', 'relic_mutant_lamia_scale', 80],
        ['海賊骷髏刀手', 'relic_pirate_bandana', 80],
        ['海賊骷髏首領', 'relic_pirate_ring', 80],
        ['巨人戰士', 'relic_giant_toothpick', 80],
        ['巨人長老', 'relic_giant_throwstone', 80],
        ['卡司特王', 'relic_redimp_nail', 80],
        ['活鎧甲', 'relic_armor_spareblade', 80],
        ['多眼怪', 'relic_beholder_gaze', 80],
        ['龍蠅', 'relic_fly_curse', 80],
        ['冰原老虎', 'relic_whitetiger_coat', 80],
        ['雪怪', 'relic_yeti_foot', 80],
        ['變形怪', 'relic_shapeshifter_underwear', 80],
        ['黑暗妖精殘兵(雙手劍)', 'relic_veteran_greatsword', 80],
        ['變種楊果里恩', 'relic_thorn_needle', 80],
        ['黑暗棲林者', 'relic_thorn_curse', 80],
        ['亞力安', 'relic_cockatrice_gaze', 80],
        // 🏺 遺物 第八批（v3.1.21·3 件）
        ['遺忘之島狼人', 'relic_moonhowl_helm', 80],
        ['遺忘之島夏洛伯', 'relic_poison_vial', 80],
        ['強化白螞蟻群', 'relic_ant_incubessence', 80],
        // 🏺 遺物 第九批（v3.1.28·10 件）
        ['阿魯巴', 'relic_aruba_haste', 80],
        ['火焰戰士', 'relic_ashwarrior_flamesword', 80],
        ['艾爾摩將軍', 'relic_deadgeneral_greatsword', 80],
        ['鋼鐵高崙', 'relic_steel_bulwark', 80],
        ['強盜頭目', 'relic_raider_belt', 80],
        ['底比斯 凱比斯(黑)', 'relic_darkscorpion_pincers', 80],
        ['遺忘之島黑暗精靈', 'relic_forgotten_sniperbow', 80],
        ['遺忘之島歐熊', 'relic_arrowfur_cloak', 80],
        ['邪惡蜥蜴', 'relic_evillizard_eye', 80],
        ['火焰弓箭手', 'relic_flamearcher_bracer', 80],   // 🏺 烈焰射手的護腕：spec 掉落源寫成物品名·取同義同級的 火焰弓箭手(fire_archer)
        // 🏺 遺物 第十批（v3.1.32·5 件）
        ['黑暗妖精警衛(十字弓)', 'relic_modded_crossbow', 80],
        ['梅杜莎', 'relic_medusa_stinger', 80],
        ['遺忘之島卡司特', 'relic_silent_venom', 80],
        ['思克巴', 'relic_charm_heart', 80],
        ['死亡之劍', 'relic_swordsman_underwear', 80],
        // 🏺 遺物 第十一批（v3.1.33·5 件）
        ['恐怖的火炎蛋', 'relic_fireegg_orb', 80],
        ['遺忘之島蛇女', 'relic_venom_avatar', 80],
        ['遺忘之島萊肯', 'relic_lycan_swiftlegs', 80],
        ['遺忘之島巨斧牛人', 'relic_axetaurus_brutalaxe', 80],
        ['遺忘之島食人妖精', 'relic_troll_belly', 80],
        // 🏺 遺物 第五批新增（v3.1.52·19 件）
        ['炎魔的思克巴', 'relic_burning_love', 80],
        ['巨大突擊螞蟻', 'relic_fearless_charge', 80],
        ['火蜥蜴', 'relic_lizard_tongue', 80],
        ['夢幻之島火蜥蜴', 'relic_flame_avatar', 80],
        ['夢幻之島殺人蜂', 'relic_killerbee_sting', 80],
        ['夢幻之島暴走兔', 'relic_runaway_carrot', 80],
        ['夢幻之島冰人', 'relic_frost_avatar', 80],
        ['黑暗妖精巡守', 'relic_handy_quiver', 80],
        ['黑暗妖精士兵', 'relic_soldier_medal', 80],
        ['邪惡密密', 'relic_evilchest_relic', 80],
        ['遺忘之島楊果里恩', 'relic_ancient_spider_claw', 80],
        ['火炎蛋', 'relic_flame_belt', 80],
        ['夢幻之島閃電球', 'relic_thunder_crown', 80],
        ['夢幻之島鎧甲守衛', 'relic_guardian_greatsword', 80],
        ['夢幻之島火炎蛋', 'relic_dream_flamesoul', 80],
        ['夢幻之島冰石高崙', 'relic_frost_stone_shield', 80],
        ['底比斯 凱比斯(紅)', 'relic_redscorpion_ring', 80],
        ['奇美拉', 'relic_cerberus_horn', 80],
        ['邪惡多眼怪', 'relic_lightbeam_wand', 80],
        // 🐍 蛇神降臨·提卡爾：寶箱碎片(初級 上/下·高級 上/下)/時空裂痕碎片 10%/龍騎士書板/祭壇鑰匙 2% + 遺物 80%
        ['提卡爾艾庫阿茲特', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫阿茲特', 'mat_rift_shard', 10], ['提卡爾艾庫阿茲特', 'bk_dragon_awaken_falion', 0.5], ['提卡爾艾庫阿茲特', 'relic_azt_mirror', 80],
        ['提卡爾艾庫阿茲特(黃)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫阿茲特(黃)', 'mat_rift_shard', 10], ['提卡爾艾庫阿茲特(黃)', 'relic_azt_prism', 80],
        ['提卡爾艾庫尤卡(藍)', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫尤卡(藍)', 'mat_rift_shard', 10], ['提卡爾艾庫尤卡(藍)', 'relic_yuka_blowdart', 80],
        ['提卡爾艾庫尤卡(白)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫尤卡(白)', 'mat_rift_shard', 10], ['提卡爾艾庫尤卡(白)', 'relic_yuka_quiver', 80],
        ['提卡爾艾庫卡伊拉(藍)', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫卡伊拉(藍)', 'bk_dragon_awaken_antares', 0.5], ['提卡爾艾庫卡伊拉(藍)', 'mat_rift_shard', 10], ['提卡爾艾庫卡伊拉(藍)', 'relic_kaira_fang', 80],
        ['提卡爾艾庫卡伊拉(黃)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫卡伊拉(黃)', 'bk_dragon_awaken_antares', 0.5], ['提卡爾艾庫卡伊拉(黃)', 'mat_rift_shard', 10], ['提卡爾艾庫卡伊拉(黃)', 'relic_kaira_hood', 80],
        ['提卡爾艾庫巴拉', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫巴拉', 'mat_rift_shard', 10], ['提卡爾艾庫巴拉', 'relic_bara_wing', 80],
        ['提卡爾艾庫巴拉(紅)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫巴拉(紅)', 'mem_cube_quake', 0.5], ['提卡爾艾庫巴拉(紅)', 'mat_rift_shard', 10], ['提卡爾艾庫巴拉(紅)', 'relic_bara_eye', 80],
        ['提卡爾艾庫艾托', 'mat_kukulkan_basic_up', 5], ['提卡爾艾庫艾托', 'bk_dragon_lavabolt', 0.5], ['提卡爾艾庫艾托', 'mat_rift_shard', 10], ['提卡爾艾庫艾托', 'relic_eto_whip', 80],
        ['提卡爾艾庫艾托(枯竭)', 'mat_kukulkan_basic_down', 5], ['提卡爾艾庫艾托(枯竭)', 'bk_dragon_lavabolt', 0.5], ['提卡爾艾庫艾托(枯竭)', 'mat_rift_shard', 10], ['提卡爾艾庫艾托(枯竭)', 'relic_eto_wand', 80],
        ['提卡爾薩德泥偶', 'mat_kukulkan_high_up', 5], ['提卡爾薩德泥偶', 'item_tikal_altar_key', 2], ['提卡爾薩德泥偶', 'mat_rift_shard', 10], ['提卡爾薩德泥偶', 'relic_mud_idol', 80],
        ['提卡爾薩德泥偶(黑)', 'mat_kukulkan_high_down', 5], ['提卡爾薩德泥偶(黑)', 'item_tikal_altar_key', 2], ['提卡爾薩德泥偶(黑)', 'mat_rift_shard', 10], ['提卡爾薩德泥偶(黑)', 'relic_mud_jar', 80],
        ['提卡爾薩德司卡(紫)', 'mat_kukulkan_high_up', 5], ['提卡爾薩德司卡(紫)', 'item_tikal_altar_key', 2], ['提卡爾薩德司卡(紫)', 'mat_rift_shard', 10], ['提卡爾薩德司卡(紫)', 'relic_ska_soul', 80],
        ['提卡爾薩德司卡(紅)', 'mat_kukulkan_high_down', 5], ['提卡爾薩德司卡(紅)', 'item_tikal_altar_key', 2], ['提卡爾薩德司卡(紅)', 'mat_rift_shard', 10], ['提卡爾薩德司卡(紅)', 'relic_ska_armguard', 80],
        ['提卡爾薩德提歐(藍)', 'mat_kukulkan_high_up', 5], ['提卡爾薩德提歐(藍)', 'item_tikal_altar_key', 2], ['提卡爾薩德提歐(藍)', 'bk_dragon_deathlightning', 0.5], ['提卡爾薩德提歐(藍)', 'mat_rift_shard', 10], ['提卡爾薩德提歐(藍)', 'relic_teo_hammer', 80],
        ['提卡爾薩德提歐(黃)', 'mat_kukulkan_high_down', 5], ['提卡爾薩德提歐(黃)', 'item_tikal_altar_key', 2], ['提卡爾薩德提歐(黃)', 'bk_dragon_deathlightning', 0.5], ['提卡爾薩德提歐(黃)', 'mat_rift_shard', 10], ['提卡爾薩德提歐(黃)', 'relic_teo_footprint', 80],
        ['提卡爾杰弗雷庫(雄)', 'amu_str', 8], ['提卡爾杰弗雷庫(雄)', 'acc_120', 8], ['提卡爾杰弗雷庫(雄)', 'amu_int', 8], ['提卡爾杰弗雷庫(雄)', 'acc_122', 8], ['提卡爾杰弗雷庫(雄)', 'acc_121', 8], ['提卡爾杰弗雷庫(雄)', 'amu_cha', 8], ['提卡爾杰弗雷庫(雄)', 'acc_demonbane', 10], ['提卡爾杰弗雷庫(雄)', 'rng_mr', 25], ['提卡爾杰弗雷庫(雄)', 'acc_117', 5], ['提卡爾杰弗雷庫(雄)', 'acc_summon_ctrl', 5], ['提卡爾杰弗雷庫(雄)', 'acc_116', 5], ['提卡爾杰弗雷庫(雄)', 'mat_tikal_fang', 3], ['提卡爾杰弗雷庫(雄)', 'mat_tikal_eye', 3], ['提卡爾杰弗雷庫(雄)', 'scroll_armor', 30], ['提卡爾杰弗雷庫(雄)', 'scroll_weapon', 30], ['提卡爾杰弗雷庫(雄)', 'item_kukulkan_box_high', 100], ['提卡爾杰弗雷庫(雄)', 'mat_crack_core', 100], ['提卡爾杰弗雷庫(雄)', 'relic_serpent_fang', 80],
        ...
        // 🏺 遺物 第十三批（v3.1.80·28 件·單一怪物專屬 80%）
        ['殘暴的骷髏斧兵', 'relic_executor_axe', 80],
        ['殘暴的骷髏槍兵', 'relic_executor_skewer', 80],
        ['獨眼巨人', 'relic_jack_sling', 80],
        ['夢魘', 'relic_endless_nightmare', 80],
        ['夢幻之島大鬼火', 'relic_dullahan_ember', 80],
        ['黑暗妖精警衛(矛)', 'relic_guard_roughgloves', 80],
        ['黑虎', 'relic_blacktiger_whip', 80],
        ['地獄束縛犬', 'relic_hellhound_chain', 80],
        ['拉斯塔巴德守門人', 'relic_gatekeeper_boots', 80],
        ['黑暗妖精法師', 'relic_dark_manaball', 80],
        ['魔狼', 'relic_blackmane_coat', 80],
        ['恐怖夢魘', 'relic_wearying_dream', 80],
        ['地之牙', 'relic_earthfang_core', 80],
        ['風之牙', 'relic_windfang_breeze', 80],
        ['水之牙', 'relic_waterfang_tear', 80],
        ['火之牙', 'relic_firefang_ember', 80],
        ['馴獸師', 'relic_tamer_dogclub', 80],
        ['巨大強化白螞蟻', 'relic_healer_wand', 80],
        ['思克巴女皇', 'relic_succubus_temptation', 80],
        ['影魔', 'relic_shadow_stinger', 80],
        ['底比斯 尖碑石奴', 'relic_weathered_obelisk', 80],
        ['魂騎士', 'relic_soulreaper_dual', 80],
        ['遺忘之島格利芬', 'relic_griffin_feather', 80],
        ['遺忘之島鏈鎚牛人', 'relic_minotaur_flail', 80],
        ['遺忘之島哈維', 'relic_vigor_belt', 80],
        ['炎魔的思克巴女皇', 'relic_succubus_wand', 80],
        ['鬼魂', 'relic_wisp_thought', 80],
        ['巫師', 'relic_warlock_grimoire', 80],
        // 🐾 v3.2.17 夥伴更新遺物（第十四批·12 件·新捕捉動物 0.0001%）
        ['老虎', 'relic_tiger_fur', 80],
        ['貓', 'relic_cat_paw', 80],
        ['熊貓', 'relic_panda_eyes', 80],
        ['高麗幼犬', 'relic_pup_fang', 80],
        ['浣熊', 'relic_raccoon_leaf', 80],
        ['聖伯納犬', 'relic_stbernard_barrel', 80],
        ['狐狸', 'relic_fox_scarf', 80],
        ['暴走兔', 'relic_rabbit_foot', 80],
        ['小獵犬', 'relic_beagle_nose', 80],
        ['柯利', 'relic_collie_fur', 80],
        ['袋鼠', 'relic_kangaroo_gloves', 80],
        ['猴子', 'relic_monkey_staff', 80],
    ].forEach(function (r) { (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], r[2]]); });
    // 🏺 v3.5.27 遺物第十八批掉落（5 件·各 0.0001%·push 追加安全）
    [
        ['暗黑黑騎士', 'relic_bk_lance', 80],
        ['水靈之主', 'relic_water_orb', 80],
        ['遺忘之島阿魯巴', 'relic_broken_halfhelm', 80],
        ['遺忘之島食人妖精王', 'relic_fire_hide', 80],
        ['深淵食屍鬼', 'relic_ghoul_visage', 80],
    ].forEach(function (r) { (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], r[2]]); });
    ...
    [
        ['嗚釜', 'mat_youkai_soul', 1], ['嗚釜', 'wpn_siruge', 0.1], ['嗚釜', 'new_item_150', 1], ['嗚釜', 'bk_elf_attrfire', 0.01], ['嗚釜', 'relic_sr_kettle_lid', 80],
        ['鎌鼬', 'mat_youkai_soul', 1], ['鎌鼬', 'hlm_wind', 0.1], ['鎌鼬', 'wpn_shaha_bow', 0.001], ['鎌鼬', 'scroll_attr_wind', 0.1], ['鎌鼬', 'bk_tornado', 0.1], ['鎌鼬', 'relic_sr_kama_pot', 80],
        ['轆轤首', 'mat_youkai_soul', 1], ['轆轤首', 'wpn_33', 0.1], ['轆轤首', 'wpn_redflame_sword', 0.1], ['轆轤首', 'wpn_redflame_bow', 0.1], ['轆轤首', 'scroll_attr_fire', 0.1], ['轆轤首', 'bk_elf_blazewpn', 0.1], ['轆轤首', 'relic_sr_neck_scarf', 80],
        ['唐傘小僧', 'mat_youkai_soul', 1], ['唐傘小僧', 'wpn_33', 0.1], ['唐傘小僧', 'scroll_attr_water', 0.1], ['唐傘小僧', 'bk_disease', 0.1], ['唐傘小僧', 'bk_elf_muddywater', 0.1], ['唐傘小僧', 'relic_sr_old_umbrella', 80],
        ['憤怒的嗚釜', 'mat_youkai_soul', 1], ['憤怒的嗚釜', 'wpn_siruge', 0.1], ['憤怒的嗚釜', 'amr_plate', 0.5], ['憤怒的嗚釜', 'bot_sephia', 0.1], ['憤怒的嗚釜', 'new_item_150', 1], ['憤怒的嗚釜', 'bk_fire_prison', 0.01], ['憤怒的嗚釜', 'relic_sr_kettle_maul', 80],
        ['鎌鼬長兄', 'mat_youkai_soul', 1], ['鎌鼬長兄', 'hlm_wind', 0.1], ['鎌鼬長兄', 'wpn_ori_dagger', 0.1], ['鎌鼬長兄', 'wpn_shaha_bow', 0.001], ['鎌鼬長兄', 'scroll_attr_wind', 0.1], ['鎌鼬長兄', 'bk_tornado', 0.1], ['鎌鼬長兄', 'relic_sr_kama_blade', 80],
        ['河童', 'mat_youkai_soul', 1], ['河童', 'wpn_claw_gloom', 0.1], ['河童', 'wpn_qigu_resonance', 0.01], ['河童', 'scroll_attr_water', 0.1], ['河童', 'bk_elf_watervital', 0.1], ['河童', 'acc_122', 0.001], ['河童', 'relic_sr_kappa_plate', 80],
        ['赤鬼', 'mat_youkai_soul', 1], ['赤鬼', 'wpn_demon_axe', 0.01], ['赤鬼', 'scroll_attr_fire', 0.1], ['赤鬼', 'acc_ring_str', 0.01], ['赤鬼', 'armguard_con', 0.01], ['赤鬼', 'arm_47', 0.1], ['赤鬼', 'bk_warrior_berserk', 0.1], ['赤鬼', 'relic_sr_akaoni_pants', 80],
        ['青鬼', 'mat_youkai_soul', 1], ['青鬼', 'scroll_weapon', 1], ['青鬼', 'scroll_armor', 1], ['青鬼', 'scroll_attr_water', 0.1], ['青鬼', 'acc_ring_con', 0.01], ['青鬼', 'armguard_con', 0.01], ['青鬼', 'bk_warrior_titan_bullet', 0.01], ['青鬼', 'relic_sr_aooni_shirt', 80],
        ['鵺', 'mat_youkai_soul', 1], ['鵺', 'scroll_weapon', 1], ['鵺', 'scroll_armor', 1], ['鵺', 'scroll_attr_earth', 0.1], ['鵺', 'wpn_red_crystalwand', 0.1], ['鵺', 'acc_118', 0.01], ['鵺', 'acc_116', 0.01], ['鵺', 'mem_pain', 0.1], ['鵺', 'bk_regen', 0.1], ['鵺', 'relic_sr_nue_tail', 80],
        ['天狗', 'mat_youkai_soul', 1], ['天狗', 'scroll_weapon', 1], ['天狗', 'scroll_armor', 1], ['天狗', 'scroll_attr_wind', 0.1], ['天狗', 'glv_wind_spirit', 0.1], ['天狗', 'acc_ring_dex', 0.01], ['天狗', 'bk_holy_dash', 0.1], ['天狗', 'bk_elf_stormshot', 0.01], ['天狗', 'relic_sr_tengu_fan', 80],
        ['阿修羅像', 'mat_youkai_soul', 1], ['阿修羅像', 'scroll_weapon', 1], ['阿修羅像', 'scroll_armor', 1], ['阿修羅像', 'wpn_siruge', 0.1], ['阿修羅像', 'wpn_katana', 1], ['阿修羅像', 'wpn_small_katana', 1], ['阿修羅像', 'glv_official', 0.1], ['阿修羅像', 'bk_spike_armor', 0.1], ['阿修羅像', 'relic_sr_asura_arm', 80],
        ['牛鬼之子', 'mat_youkai_soul', 0.1], ['牛鬼之子', 'new_item_150', 1], ['牛鬼之子', 'relic_sr_child_ring', 80],
        ['白面金毛九尾狐・殺生石', 'mat_youkai_soul', 5], ['白面金毛九尾狐・殺生石', 'scroll_weapon', 10], ['白面金毛九尾狐・殺生石', 'scroll_armor', 10], ['白面金毛九尾狐・殺生石', 'scroll_attr_water', 1], ['白面金毛九尾狐・殺生石', 'scroll_attr_fire', 1], ['白面金毛九尾狐・殺生石', 'glv_water_spirit', 1], ['白面金毛九尾狐・殺生石', 'glv_fire_spirit', 1], ['白面金毛九尾狐・殺生石', 'acc_117', 1], ['白面金毛九尾狐・殺生石', 'bk_resurrection', 3], ['白面金毛九尾狐・殺生石', 'bk_fire_storm', 1], ['白面金毛九尾狐・殺生石', 'bk_meteor', 0.5], ['白面金毛九尾狐・殺生石', 'bk_heal_energy_storm', 0.5], ['白面金毛九尾狐・殺生石', 'bk_elf_attrfire', 1], ['白面金毛九尾狐・殺生石', 'bk_elf_lifebless', 1], ['白面金毛九尾狐・殺生石', 'bk_elf_lifespring', 1], ['白面金毛九尾狐・殺生石', 'wpn_onmyoji_fan', 0.1], ['白面金毛九尾狐・殺生石', 'wpn_qigu_sapphire', 0.1], ['白面金毛九尾狐・殺生石', 'acc_126', 1], ['白面金毛九尾狐・殺生石', 'amu_int', 1], ['白面金毛九尾狐・殺生石', 'wpn_katana', 10], ['白面金毛九尾狐・殺生石', 'wpn_siruge', 2], ['白面金毛九尾狐・殺生石', 'wpn_crimson_spear', 2], ['白面金毛九尾狐・殺生石', 'arm_95', 1], ['白面金毛九尾狐・殺生石', 'acc_136', 0.01], ['白面金毛九尾狐・殺生石', 'bk_warrior_titan_magic', 1], ['白面金毛九尾狐・殺生石', 'relic_sr_kyuubi_wand', 80],
        ['牛鬼', 'mat_youkai_soul', 5], ['牛鬼', 'scroll_weapon', 10], ['牛鬼', 'scroll_armor', 10], ['牛鬼', 'scroll_attr_earth', 3], ['牛鬼', 'glv_earth_spirit', 3], ['牛鬼', 'clk_pride_earth', 1], ['牛鬼', 'acc_summon_ctrl', 1], ['牛鬼', 'bk_earthquake', 10], ['牛鬼', 'bk_quake', 3], ['牛鬼', 'bk_soul_up', 1], ['牛鬼', 'bk_elf_steelguard', 3], ['牛鬼', 'bk_elf_earthbless', 3], ['牛鬼', 'bk_elf_physboost', 1], ['牛鬼', 'bk_dragon_awaken_antares', 3], ['牛鬼', 'bk_elf_triple', 2], ['牛鬼', 'wpn_onmyoji_fan', 0.1], ['牛鬼', 'wpn_qigu_obsidian', 1], ['牛鬼', 'wpn_chain_destroyer', 1], ['牛鬼', 'wpn_official_2h', 3], ['牛鬼', 'wpn_vengeance', 0.1], ['牛鬼', 'acc_138', 1], ['牛鬼', 'rng_mr', 1], ['牛鬼', 'amu_str', 1], ['牛鬼', 'acc_121', 1], ['牛鬼', 'wpn_katana', 10], ['牛鬼', 'wpn_siruge', 2], ['牛鬼', 'wpn_claw_abyss', 1], ['牛鬼', 'bk_warrior_titan_rock', 1], ['牛鬼', 'relic_sr_ushioni_horn', 80],
        ['巨大骷髏', 'mat_youkai_soul', 5], ['巨大骷髏', 'mat_gasha_soul', 1], ['巨大骷髏', 'scroll_weapon', 10], ['巨大骷髏', 'scroll_armor', 10], ['巨大骷髏', 'scroll_attr_earth', 3], ['巨大骷髏', 'scroll_attr_water', 3], ['巨大骷髏', 'scroll_attr_fire', 3], ['巨大骷髏', 'scroll_attr_wind', 3], ['巨大骷髏', 'acc_117', 5], ['巨大骷髏', 'acc_summon_ctrl', 5], ['巨大骷髏', 'acc_116', 5], ['巨大骷髏', 'bk_abs_barrier', 5], ['巨大骷髏', 'bk_resurrection', 1], ['巨大骷髏', 'bk_blizzard_storm', 1], ['巨大骷髏', 'bk_disintegrate', 1], ['巨大骷髏', 'bk_meteor', 1], ['巨大骷髏', 'bk_elf_stormshot', 3], ['巨大骷髏', 'bk_elf_flamesoul', 3], ['巨大骷髏', 'bk_dragon_awaken_baraka', 3], ['巨大骷髏', 'bk_elf_triple', 2], ['巨大骷髏', 'bk_elf_soul', 2], ['巨大骷髏', 'wpn_onmyoji_fan', 0.1], ['巨大骷髏', 'blt_gasha_ring', 0.1], ['巨大骷髏', 'wpn_qigu_meditate', 1], ['巨大骷髏', 'wpn_chain_bloodthirst', 1], ['巨大骷髏', 'wpn_giantaxe', 10], ['巨大骷髏', 'wpn_demon_axe', 1], ['巨大骷髏', 'wpn_thor_hammer', 1], ['巨大骷髏', 'wpn_demon_axehead', 1], ['巨大骷髏', 'acc_122', 1], ['巨大骷髏', 'acc_121', 1], ['巨大骷髏', 'wpn_katana', 10], ['巨大骷髏', 'wpn_siruge', 2], ['巨大骷髏', 'wpn_dual_abyss', 1], ['巨大骷髏', 'wpn_rond_dual', 1], ['巨大骷髏', 'bot_courage', 1], ['巨大骷髏', 'bot_mana', 1], ['巨大骷髏', 'bk_dark_armorbreak', 1], ['巨大骷髏', 'acc_136', 1], ['巨大骷髏', 'acc_137', 1], ['巨大骷髏', 'acc_135', 1], ['巨大骷髏', 'bk_counter_barrier', 1], ['巨大骷髏', 'relic_sr_gasha_skull', 80],
    ].forEach(function (r) { (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], r[2]]); });
    ...
    (MOB_DROPS['真‧死亡騎士 冥皇丹特斯'] = MOB_DROPS['真‧死亡騎士 冥皇丹特斯'] || []).push(['wpn_uncursed_emperor_blade', 80]);
...
[['西瑪','relic_orin_ring'],['拉斯塔巴德馴獸師','relic_tamer_feedbag'],['地元素守護者','relic_earth_barrier'],['水元素守護者','relic_water_barrier'],['火元素守護者','relic_fire_barrier'],['風元素守護者','relic_wind_barrier'],['殘暴的食屍鬼','relic_ghoul_fang'],['殘暴的史巴托','relic_sparto_shard'],['受詛咒的妖魔殭屍','relic_corpse_needle'],['遺忘之島變形怪','relic_morph_blade'],['遺忘之島巨大鱷魚','relic_croc_leather'],['遺忘之島卡司特王','relic_kasta_hump'],['德雷克','relic_pirate_dual'],['熔岩高崙','relic_lava_fists']].forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 80]));
...
[['歐姆戰士','relic_heavy_belt'],['殘暴的骷髏神射手','relic_bone_bow'],['殘暴的骷髏鬥士','relic_fighter_armor'],['幼龍','relic_drake_pawprint'],['火焰之靈魂(紅)','relic_red_wraith'],['受詛咒的艾爾摩法師','relic_mage_dagger']].forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 80]));
// 🏺 v3.6.44 遺物 第十九批掉落（15 件·各 0.0001%·「墳墓守護者」拆法師＋騎士兩隻同率）
[['深淵弓箭手','relic_marksman_corset'],['地靈之主','relic_earthshatter_sword'],['風靈之主','relic_gale_fistblade'],['火靈之主','relic_hellfire_hammer'],['墳墓守護者法師','relic_pet_devotion'],['墳墓守護者騎士','relic_pet_devotion'],['血色術士','relic_blood_ritual_dagger'],['恐怖的伊弗利特','relic_genie_wishes'],['火焰之靈魂(藍)','relic_cold_blueflame'],['火焰烈炎獸','relic_scorch_greatsword'],['底比斯 斯芬克斯','relic_guardian_riddle'],['闇黑君王','relic_mana_array_boots'],['血騎士','relic_bloodknight_dual'],['骨龍','relic_cursed_egg'],['受詛咒的艾爾摩士兵','relic_elmo_spear'],['遺忘之島亞力安','relic_petrify_essence']].forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 80]));
...
[['烈炎獸','relic_lava_nozzle'],['飛龍','relic_doom_egg'],['重裝歐姆戰士','relic_crusher_hammer']].forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 80]));
...
[['遺忘之島飛龍','relic_doomsday_egg'],['深淵地靈','relic_calamity_egg']].forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 80]));
...
[['遺忘之島巨大牛人','relic_maze_demon_glare'],['拉斯塔巴德近衛隊','relic_lining_chainshirt'],['冷酷冰原老虎','relic_icefang_armguard'],
 ...
 ['曼波兔','relic_treasured_carrot'],['墳墓守護者騎士','relic_cross_tombshield'],['象牙塔紙人','relic_mage_scrap_note']].forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 80]));
...
[['象牙塔石頭高崙','relic_golem_lifemark'],['象牙塔密密','relic_serrated_fangs'],['克特','relic_kurt_shield'],
 ...
 ['卡魯塔','relic_ghost_teardrop'],['卡瑞','relic_true_dragonslayer'],['死亡騎士','relic_flame_dk_sword']].forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 80]));
...
[['底比斯 尼荷斯(藍)','relic_sky_god_avatar'],['死亡的司祭(思克巴)','relic_necro_book']]
    .forEach(r => (MOB_DROPS[r[0]] = MOB_DROPS[r[0]] || []).push([r[1], 80]));
